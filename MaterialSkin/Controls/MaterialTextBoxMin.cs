namespace MaterialSkin.Controls
{
    ...
    public class MaterialTextBoxMin : Control, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                //No animation
                g.FillRectangle(_baseTextBox.Focused ? UseAccent ? SkinManager.ColorScheme.AccentBrush : SkinManager.ColorScheme.PrimaryBrush : SkinManager.GetDividersBrush(), _baseTextBox.Location.X, lineY, _baseTextBox.Width, _baseTextBox.Focused ? 2 : 1);
            }
            else
            {
                //Animate
                ...
                g.FillRectangle(UseAccent ? SkinManager.ColorScheme.AccentBrush : SkinManager.ColorScheme.PrimaryBrush, animationStart - halfAnimationWidth, lineY, animationWidth, 2);
            }
        }
